...
$10^{13}$ & $599,582$ & $30,396,355,092,702,898,919,527,444$ & $-966,578$ & $346,065,536,839$ & \textbf{5.1809 s} \\
$10^{14}$ & $-875,575$ & $3,039,635,509,270,144,893,910,357,854$ & $-7,424,752$ & $3,204,941,750,802$ & \textbf{29.7968 s} \\
$10^{15}$ & $-3,216,373$ & $303,963,550,927,013,509,478,708,835,152$ & $-29,445,104$ & $29,844,570,422,669$ & \textbf{160.1818 s} \\
$10^{16}$ & $-3,195,437$ & --- & --- & $279,238,341,033,925$ & \textbf{927.8322 s} \\
\bottomrule
\end{tabular}%
}
...
\begin{itemize}
    ...
    \item \textbf{Thread Pool:} 15 OpenMP worker threads operating under dynamic task distribution (\texttt{schedule(dynamic, 64)}).
\end{itemize}
