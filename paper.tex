...
\end{enumerate}
We implement this architecture in an open-source C++20 template library supporting arbitrary Dirichlet convolutions. We report empirical benchmarks scaling to $X = 10^{14}$ (100 trillion), computing $M(10^{12}) = 62,366$ in \textbf{5.56 seconds} and $M(10^{14}) = -875,575$ in \textbf{165.2 seconds} on consumer hardware with 15 parallel threads.
\end{abstract}
...
\midrule
$10^7$ & $1,037$ & $30,396,356,427,242$ & $-842$ & $664,579$ & \textbf{0.0036 s} \\
$10^8$ & $1,928$ & $3,039,635,538,981,878$ & $-530$ & $5,761,455$ & \textbf{0.0182 s} \\
$10^9$ & $-222$ & $303,963,551,391,249,150$ & $-14$ & $50,847,534$ & \textbf{0.0610 s} \\
$10^{10}$ & $-33,722$ & $30,396,355,092,886,216,366$ & $-116,026$ & $455,052,511$ & \textbf{0.2050 s} \\
$10^{11}$ & $-87,856$ & $3,039,635,510,883,674,842,482$ & $-447,214$ & $4,118,054,813$ & \textbf{1.0841 s} \\
$10^{12}$ & $62,366$ & $303,963,550,927,059,804,025,910$ & $-522,626$ & $37,607,912,018$ & \textbf{5.5660 s} \\
$10^{13}$ & $599,582$ & --- & --- & --- & \textbf{29.9184 s} \\
$10^{14}$ & $-875,575$ & --- & --- & --- & \textbf{165.2001 s} \\
\bottomrule
\end{tabular}
\caption{Multi-scale evaluation across arithmetic functions using 15 OpenMP threads. Results up to $10^{14}$ match established mathematical literature \cite{kotnik2004order, kuznetsov2011computing}.}
\label{tab:benchmarks}
\end{table}

\subsection{Speedup and Scaling Discussion}
At $X = 10^{13}$, the parallel doubling schedule computes $M(10^{13}) = 599,582$ in **29.91 seconds**, representing an **$11.8\times$ speedup** over single-threaded baselines. At $X = 10^{14}$, the state space $|\V(X)| \approx 2 \times 10^7$ requires only $\sim 80\text{ MB}$ of memory, completing the computation in **165.2 seconds**.
